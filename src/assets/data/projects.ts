...
export const projects: Array<IProjects> = [
    {
        name: "Editor Mobile",
        description: "O Editor mobile é um site que divulga um curso de edição de vídeos que pode ser feito apenas pelo celular.",
        pathImg: "../../../assets/images/editor-mobile.png",
